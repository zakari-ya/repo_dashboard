      ...
      <div className="space-y-8 sm:space-y-9">
        <section className="rounded-lg border border-border bg-surface p-5 shadow-[var(--shadow-card)] sm:p-6 lg:p-7">
          <div className="max-w-3xl">
            <p className="text-sm font-semibold text-accent">Vue d’ensemble</p>
            ...
            <p className="mt-4 max-w-2xl text-base leading-7 text-text-muted">
              Cette page présente les repositories simulés, les langages
              détectés et les fichiers sensibles à surveiller en priorité.
            </p>
          </div>
        </section>
